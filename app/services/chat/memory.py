...
class SessionManager:
    ...
    def update_context(self, session_id: str, branch: Optional[str] = None, grade: Optional[str] = None, pending_query: Optional[str] = None):
    ...
    def get_context(self, session_id: str) -> Dict[str, Optional[str]]:
        ...
        return {"branch": None, "grade": None, "pending_query": None}
